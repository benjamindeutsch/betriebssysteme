 ...
 * @param vertex the id of the vertex that should be searched for
...
/**
 * @brief returns the index of the vertex with the given id or -1 if no vertex with the given id is found
 * @param list the list that the vertex should be searched in
 * @param vertex the id of the vertex that should be searched for
 * @return the index of the vertex if the list contains the vertex, -1 otherwise
 */
